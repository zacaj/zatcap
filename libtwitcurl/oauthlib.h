...
namespace oAuthTwitterApiUrls
{
    ...
    const std::string OAUTHLIB_TWITTER_REQUEST_TOKEN_URL = "https://api.twitter.com/oauth/request_token";
    const std::string OAUTHLIB_TWITTER_AUTHORIZE_URL = "https://api.twitter.com/oauth/authorize?oauth_token=";
    const std::string OAUTHLIB_TWITTER_ACCESS_TOKEN_URL = "https://api.twitter.com/oauth/access_token";
};
